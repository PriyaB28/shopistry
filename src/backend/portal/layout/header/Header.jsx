...
import faceImg from '../../../../assets/backend/images/faces/9.jpg'
import './header.css'
                        ...
                        <div className="header-content-left">
                            ...
                            <div className="header-element md:px-[0.325rem] !items-center">
                                ...
                                <a aria-label="Hide Sidebar"
                                    className="sidemenu-toggle animated-arrow  hor-toggle horizontal-navtoggle inline-flex items-center" href="#"><span></span></a>
                                {/* <!-- End::header-link --> */}
                            </div>
                            {/* <!-- End::header-element --> */}
                        </div>
                        ...
                        <div className="header-content-right">
                            ...
                            <div className="header-element py-[1rem] md:px-[0.65rem] px-2  header-country hs-dropdown ti-dropdown  hidden sm:block [--placement:bottom-left]">
                                <button id="dropdown-flag" type="button"
                                    ...
                                    <img src="../assets/images/flags/us_flag.jpg" alt="flag-img" className="h-[1.25rem] w-[1.25rem] rounded-full" />
                                </button>
                                ...
                                <div className="main-header-dropdown bg-white !-mt-3 !p-0 hs-dropdown-menu ti-dropdown-menu w-[22rem] border-0 border-defaultborder hidden"
                                            ...
                                            <div className="grow">
                                                <div className="flex items-start justify-between mb-0">
                                                    ...
                                                    <div className="inline-flex">
                                                        <span className="text-black mb-1 dark:text-white !font-medium">$1,299.00</span>
                                                        <a aria-label="anchor" href="#" className="header-cart-remove ltr:float-right rtl:float-left dropdown-item-close"><i
                                    ...
                                    <li className="ti-dropdown-item border-b dark:border-defaultborder/10 border-defaultborder">
                                        ...
                                        <div className="grow">
                                            ...
                                            <div className="inline-flex">
                                                <span className="text-black dark:text-white !font-medium mb-1">$179.29</span>
                                                <a aria-label="anchor" href="#" className="header-cart-remove ltr:float-right rtl:float-left dropdown-item-close"><i
                                                    className="ti ti-trash"></i></a>
                                            </div>
                                            </div>
                                    ...
                                    <li className="ti-dropdown-item border-b dark:border-defaultborder/10 border-defaultborder">
                                        ...
                                        <div className="grow">
                                            ...
                                            <div className="inline-flex">
                                                <span className="text-black !font-medium mb-1 dark:text-white">$29.00</span>
                                                <a aria-label="anchor" href="#" className="header-cart-remove ltr:float-right rtl:float-left dropdown-item-close"><i
                                                    className="ti ti-trash"></i></a>
                                            </div>
                                            </div>
                                    ...
                                    <li className="ti-dropdown-item border-b dark:border-defaultborder/10 border-defaultborder">
                                        ...
                                        <div className="grow">
                                            ...
                                            <div className="inline-flex">
                                                <span className="text-black !font-medium mb-1 dark:text-white">$4,999.00</span>
                                                <a aria-label="anchor" href="#" className="header-cart-remove ltr:float-right rtl:float-left dropdown-item-close"><i
                                                    className="ti ti-trash"></i></a>
                                            </div>
                                            </div>
                                    ...
                                    <li className="ti-dropdown-item">
                                        ...
                                        <div className="grow">
                                            ...
                                            <div className="inline-flex">
                                                <span className="text-black !font-medium mb-1 dark:text-white">$129.00</span>
                                                <a aria-label="anchor" href="#" className="header-cart-remove ltr:float-right rtl:float-left dropdown-item-close"><i
                                                    className="ti ti-trash"></i></a>
                                            </div>
                                            </div>
                                    ...
                                    <div className="grid">
                                        <a href="checkout.html" className="w-full ti-btn ti-btn-primary-full p-2">Proceed to checkout</a>
                                    </div>
                                    </div>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <a href="products.html" className="ti-btn ti-btn-primary btn-wave ti-btn-wave btn-sm m-1 !text-[0.75rem] !py-[0.25rem] !px-[0.5rem]"
                                ...
                                <div className="main-header-dropdown !-mt-3 !p-0 hs-dropdown-menu ti-dropdown-menu bg-white !w-[22rem] border-0 border-defaultborder hidden !m-0"
                                    ...
                                    <li className="ti-dropdown-item dropdown-item ">
                                        ...
                                        <div className="grow flex items-center justify-between">
                                            <div>
                                            <p className="mb-0 text-defaulttextcolor dark:text-[#8c9097] dark:text-white/50 text-[0.8125rem] font-semibold"><a
                                            ...
                                            <div>
                                            <a aria-label="anchor" href="#" className="min-w-fit text-[#8c9097] dark:text-white/50 me-1 dropdown-item-close1"><i
                                    ...
                                    <li className="ti-dropdown-item dropdown-item !flex-none">
                                        ...
                                        <div className="grow flex items-center justify-between">
                                            ...
                                            <span className="text-[#8c9097] dark:text-white/50 font-normal text-[0.75rem] header-notification-text">Discount
                                    ...
                                    <li className="ti-dropdown-item dropdown-item">
                                        ...
                                        <div className="grow flex items-center justify-between">
                                            ...
                                            <span className="text-[#8c9097] dark:text-white/50 font-normal text-[0.75rem] header-notification-text">Your Account Has
                                    ...
                                    <li className="ti-dropdown-item dropdown-item">
                                        ...
                                        <div className="grow flex items-center justify-between">
                                            <div>
                                            <p className="mb-0 text-defaulttextcolor dark:text-[#8c9097] dark:text-white/50  text-[0.8125rem]  font-semibold"><a
                                                href="notifications.html">Order Placed <span className="text-warning">ID: #1116773</span></a></p>
                                            <span className="text-[#8c9097] dark:text-white/50 font-normal text-[0.75rem] header-notification-text">Order Placed
                                                Successfully</span>
                                            </div>
                                            <div>
                                            <a aria-label="anchor" href="#" className="min-w-fit text-[#8c9097] dark:text-white/50 me-1 dropdown-item-close1"><i
                                    ...
                                    <li className="ti-dropdown-item dropdown-item">
                                        ...
                                        <div className="grow flex items-center justify-between">
                                            <div>
                                            <p className="mb-0 text-defaulttextcolor dark:text-[#8c9097] dark:text-white/50  text-[0.8125rem]  font-semibold"><a
                                                href="notifications.html">Order Delayed <span className="text-success">ID: 7731116</span></a></p>
                                            <span className="text-[#8c9097] dark:text-white/50 font-normal text-[0.75rem] header-notification-text">Order Delayed
                                                Unfortunately</span>
                                            </div>
                                            <div>
                                            <a aria-label="anchor" href="#" className="min-w-fit text-[#8c9097] dark:text-white/50 me-1 dropdown-item-close1"><i
                                    ...
                                    <div className="grid">
                                        <a href="notifications.html" className="ti-btn ti-btn-primary-full !m-0 w-full p-2">View All</a>
                                    </div>
                                    </div>
                                            ...
                                            <div className="">
                                                <a href="#" className="p-4 items-center related-app block text-center rounded-sm hover:bg-gray-50 dark:hover:bg-black/20">
                                                    ...
                                                    <img src="../assets/images/apps/figma.png" alt="figma"
                                                        className="!h-[1.75rem] !w-[1.75rem] text-2xl text-primary flex justify-center items-center mx-auto" />
                            ...
                            <div className="header-element header-fullscreen py-[1rem] md:px-[0.65rem] px-2">
                                {/* <!-- Start::header-link --> */}
                                {/* <a aria-label="anchor" onClick="openFullscreen();" href="#" */}
                            ...
                            {/* <!-- Header Profile --> */}
                            <div className="header-element md:!px-[0.65rem] px-2 hs-dropdown !items-center ti-dropdown [--placement:bottom-left]  group/btn hover:open">

                                <button id="dropdown-profile" type="button"
                                    className="hs-dropdown-toggle ti-dropdown-toggle !gap-2 !p-0 flex-shrink-0 sm:me-2 me-0 !rounded-full !shadow-none text-xs align-middle !border-0 !shadow-transparent group/btn ">
                                    <img className="inline-block rounded-full " src={faceImg}  width="32" height="32" alt="Image Description" />
                                </button>
                                ...
                                <div className="hs-dropdown-menu bg-slate-900 !-mt-3 border-0 w-[11rem] !p-0 border-defaultborder main-header-dropdown pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end hidden test group-hover/btn:!block" aria-labelledby="dropdown-profile" style={{position: 'fixed', inset: '0px auto auto 0px', margin: '0px'}} data-popper-placement="bottom-start">
                                    <ul className="text-defaulttextcolor font-medium dark:text-[#8c9097] dark:text-white/50"> <li> <a className="w-full ti-dropdown-item !text-[0.8125rem] !gap-x-0  !p-[0.65rem] !inline-flex" href="profile.html"> <i className="ti ti-user-circle text-[1.125rem] me-2 opacity-[0.7]"></i>Profile </a> </li> <li> <a className="w-full ti-dropdown-item !text-[0.8125rem] !gap-x-0  !p-[0.65rem] !inline-flex" href="mail.html"><i className="ti ti-inbox text-[1.125rem] me-2 opacity-[0.7]"></i>Inbox <span className="!py-1 !px-[0.45rem] !font-semibold !rounded-sm text-success text-[0.75em] bg-success/10 ms-auto">25</span> </a> </li> <li><a className="w-full ti-dropdown-item !text-[0.8125rem] !gap-x-0 !p-[0.65rem] !inline-flex" href="todo.html"><i className="ti ti-clipboard-check text-[1.125rem] me-2 opacity-[0.7]"></i>Task Manager</a></li>
                                        <li><a className="w-full ti-dropdown-item !text-[0.8125rem] !gap-x-0 !p-[0.65rem] !inline-flex" href="mail-settings.html"><i className="ti ti-adjustments-horizontal text-[1.125rem] me-2 opacity-[0.7]"></i>Settings</a></li>
                                        <li><a className="w-full ti-dropdown-item !text-[0.8125rem] !gap-x-0 !p-[0.65rem] !inline-flex " href=""><i className="ti ti-wallet text-[1.125rem] me-2 opacity-[0.7]"></i>Bal: $7,12,950</a></li>
                                        <li><a className="w-full ti-dropdown-item !text-[0.8125rem] !p-[0.65rem] !gap-x-0 !inline-flex" href="chat.html"><i className="ti ti-headset text-[1.125rem] me-2 opacity-[0.7]"></i>Support</a></li>
                                        <li><button onClick={handleLogout} className="w-full ti-dropdown-item !text-[0.8125rem] !p-[0.65rem] !gap-x-0 !inline-flex" ><i className="ti ti-logout text-[1.125rem] me-2 opacity-[0.7]"></i>Log Out</button></li> </ul> </div>
                            </div>
                            {/* <!-- End Header Profile --> */}
