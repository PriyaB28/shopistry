...
import {Heart, Eye, Bookmark} from 'react-flaticons'

function Home() {
    return (
        <>
            {/* <!-- Start Hero --> */}
            <section className="relative md:flex table w-full items-center md:h-screen py-36 bg-emerald-500/5 bg-[url('./assets/frontend/images/hero/bg3.png')] md:bg-top bg-center bg-no-repeat bg-cover">
                ...
                <div className="container relative">
                    ...
                    <div className="grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 pt-6 gap-6">
                        <a href="#" className="text-center hover:text-orange-500">
                            <img src={images.menswear} className="rounded-full shadow dark:shadow-gray-800" alt="" />
                            <span className="text-xl font-medium mt-3 block">Men's Wear</span>
                        </a>

                        <a href="#" className="text-center hover:text-orange-500">
                            <img src={images.ladieswear} className="rounded-full shadow dark:shadow-gray-800" alt="" />
                            <span className="text-xl font-medium mt-3 block">Ladies Wear</span>
                        </a>

                        <a href="#" className="text-center hover:text-orange-500">
                            <img src={images.kidsware} className="rounded-full shadow dark:shadow-gray-800" alt="" />
                            <span className="text-xl font-medium mt-3 block">Kids Wear</span>
                        </a>

                        <a href="#" className="text-center hover:text-orange-500">
                            <img src={images.smartwatch} className="rounded-full shadow dark:shadow-gray-800" alt="" />
                            <span className="text-xl font-medium mt-3 block">Smart Watch</span>
                        </a>

                        <a href="#" className="text-center hover:text-orange-500">
                            <img src={images.sunglasses} className="rounded-full shadow dark:shadow-gray-800" alt="" />
                    ...
                    <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 pt-6 gap-6">
                        <div className="group">
                            <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                                <img src={images.blackShirt} className="group-hover:scale-110 duration-500" alt="" />
                                ...
                                <ul className="list-none absolute top-[10px] end-4 opacity-0 group-hover:opacity-100 duration-500 space-y-1">
                                    <li><a href="#" className="size-10 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-center rounded-full bg-white text-slate-900 hover:bg-slate-900 hover:text-white shadow"><Heart className='fi fi-rs-heart'/></a></li>
                                    <li className="mt-1"><a href="shop-item-detail.html" className="size-10 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-center rounded-full bg-white text-slate-900 hover:bg-slate-900 hover:text-white shadow"><Eye/></a></li>
                                    <li className="mt-1"><a href="#" className="size-10 inline-flex items-center justify-center tracking-wide align-middle duration-500 text-center rounded-full bg-white text-slate-900 hover:bg-slate-900 hover:text-white shadow"><Bookmark/></a></li>
                                </ul>
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                                <img src={images.fashionSneaker} className="group-hover:scale-110 duration-500" alt="" />
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                                <img src={images.menWhiteShoes} className="group-hover:scale-110 duration-500" alt="" />
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                                <img src={images.luxuriousBag} className="group-hover:scale-110 duration-500" alt="" />
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                                <img src={images.ladies1} className="group-hover:scale-110 duration-500" alt="" />
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                                <img src={images.ladies2} className="group-hover:scale-110 duration-500" alt="" />
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                                <img src={images.mensJacket} className="group-hover:scale-110 duration-500" alt="" />
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                                <img src={images.sweaterTshirt} className="group-hover:scale-110 duration-500" alt="" />
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                                <img src={images.trendyTshirt2} className="group-hover:scale-110 duration-500" alt="" />
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                                <img src={images.menSunglasses} className="group-hover:scale-110 duration-500" alt="" />
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                                <img src={images.womenWhiteShoes} className="group-hover:scale-110 duration-500" alt="" />
                        ...
                        <div className="group">
                            <div className="relative overflow-hidden shadow dark:shadow-gray-800 group-hover:shadow-lg group-hover:dark:shadow-gray-800 rounded-md duration-500">
                                <img src={images.casualMenShorts} className="group-hover:scale-110 duration-500" alt="" />
