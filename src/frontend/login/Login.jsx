...
function Login() {
    ...
    return (
        <section className={`md:h-screen py-36 flex items-center bg-orange-500/10 dark:bg-orange-500/20 bg-[url('./assets/frontend/images/hero/bg-shape.png')] bg-center bg-no-repeat bg-cover`}>
                            ...
                            <div className="p-8 lg:px-20">
                                ...
                                <form className="text-start lg:py-20 py-8" onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-4">
                                            ...
                                            <input  type="text" name='role' className="mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-100 dark:border-gray-800 focus:ring-0" placeholder="role" onChange={(e)=>(setRole(e.target.value))} />
                                        </div>

                                        <div className="mb-4">
                                            <label className="font-semibold" >Password:</label>
                                            <input id="LoginPassword" name='password' type="password" className="mt-3 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border border-gray-100 dark:border-gray-800 focus:ring-0" placeholder="Password:" onChange={(e)=>(setPassword(e.target.value))} />
                                        </div>
